...
class Car:
    def __init__(self, comfort_class: int, cleanliness_mark: int, model: str) -> None:
...
class CarWashStation:
    def __init__(self, bays: int, water_liters: int, price_per_wash: float, max_capacity: int) -> None:
        self.bays: int = bays
